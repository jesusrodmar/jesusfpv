...
export const metadata: Metadata = {
  title: "Reviews FPV — Análisis honestos de drones y componentes | JESUS FPV",
  description: "Reviews y análisis honestos de drones FPV, componentes, emisoras y gafas. Pros, contras, puntuación y links de afiliado.",
  alternates: { canonical: "https://jesusfpv.com/guias/reviews" },
};
      ...
      <section style={{ background: "#141414", borderBottom: "1px solid rgba(255,255,255,0.07)", padding: "clamp(3rem,7vw,5rem) clamp(1.5rem,5vw,4rem)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <nav aria-label="Migas de pan" style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: "1.5rem", flexWrap: "wrap" }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.2)", fontSize: "0.75rem" }}>›</span>
            <span style={{ fontFamily: '"Exo 2", sans-serif', fontSize: "0.8rem", color: NEON, fontWeight: 600 }}>Reviews</span>
          </nav>
          ...
          <p style={{ fontFamily: '"Exo 2", sans-serif', fontSize: "1.05rem", color: TEXT, lineHeight: 1.7, maxWidth: 600 }}>
            Análisis honestos de drones, componentes y equipos FPV. Solo lo que he probado o investigado a fondo.
          </p>
        </div>
      </section>
      <section style={{ padding: "clamp(3rem,7vw,5rem) clamp(1.5rem,5vw,4rem)" }}>
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontFamily: '"Exo 2", sans-serif', fontSize: "1rem", color: MUTED }}>
            Reviews próximamente. Vuelve pronto.
          </p>
        </div>
      </section>
    </div>
